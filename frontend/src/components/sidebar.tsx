...
const NAV_ITEMS = [
  ...
  { href: "/upload", label: "Upload Call", icon: "M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" },
  ...
  return (
    <aside className="w-64 min-h-screen bg-slate-900 text-white flex flex-col">
      <div className="p-6 border-b border-slate-700">
        <h1 className="text-xl font-bold">Vernanda QA</h1>
        <p className="text-xs text-slate-400 mt-1">Sales Call Quality Assurance</p>
      </div>
      ...
      <div className="p-4 border-t border-slate-700">
        <p className="text-xs text-slate-500">Veranda Race QA System v1.0</p>
      </div>
    </aside>
  );
}
